...
<body class="${locale}"
	background="${contextPath}/templates/default/images/light.jpg">
							...
							<table cellspacing="0" cellpadding="2" border="0" width="100%">
								<tr>
									...
									<td valign="top" nowrap="nowrap" align="center" width="80%">&nbsp;
										<img
										src="${contextPath}/templates/default/images/icon_mini_search.gif"
										alt="[Search]" /> <span class="mainmenu"><a
											id="search" class="mainmenu" href="#" rel="nofollow"><b><fmt:message
														key="header.jsp.search" /></b></a> &nbsp; <img
											src="${contextPath}/templates/default/images/icon_mini_recentTopics.gif"
											...
											src="${contextPath}/templates/default/images/icon_mini_members.gif"
											...
											<img
											src="${contextPath}/templates/default/images/icon_mini_groups.gif"
											...
											<c:when test="${sessionScope.userSession.login}">
												<span class="mainmenu"> <c:if
													...
													href="${contextPath}/displayMyProfile.do?userId=${sessionScope.userSession.userId}">
														<img
														src="${contextPath}/templates/default/images/icon_mini_profile.gif"
													...
													href="${contextPath}/displayPrivateMsgInbox.do?userId=${sessionScope.userSession.userId}">
														<img
														src="${contextPath}/templates/default/images/icon_mini_message.gif"
													...
													href="${contextPath}/logout.do"> <img
														src="${contextPath}/templates/default/images/icon_mini_login.gif"
											...
											<c:otherwise>
												<span class="mainmenu"> <a id="register"
													...
													rel="nofollow"> <img
														src="${contextPath}/templates/default/images/icon_mini_register.gif"
														border="0" alt="[Register]" /> <fmt:message
															key="header.jsp.register" />
												</a>&nbsp; <a id="login" class="mainmenu"
													href="${contextPath}/forum/user/login/init.do"
													rel="nofollow"> <img
														src="${contextPath}/templates/default/images/icon_mini_login.gif"
														border="0" alt="[Login]" /> <fmt:message
									...
									<td valign="buttom" nowrap="nowrap" align="right"
										...
										href="http://weibo.com/u/3905573711" target="_blank"><img
											src="${contextPath}/templates/default/images/sina_weibo.jpg"></a>&nbsp;<a
										target="_blank"
										href="http://wp.qq.com/wpa/qunwpa?idkey=7ec66e261a75d5469307699b80d5595e8b5f62a1c3db0c2c1ce0da621ea164ed"><img
											border="0"
											src="${contextPath}/templates/default/images/qq_group.jpg"
